...
public class IrinaBTest extends BaseTest {
    ...
    public void testIrinaB2() {
        ...
        WebElement chooseYourAccountOption = getDriver().findElement(
                By.xpath("//div[@class='selection-item']/input[@id='BROKERAGE']"));

        Assert.assertTrue(chooseYourAccountOption.isSelected());
